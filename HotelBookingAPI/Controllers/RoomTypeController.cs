...
namespace HotelBookingAPI.Controllers
{
    ...
    public class RoomTypeController : ControllerBase
    {
        ...
        {
            _logger.LogInformation("Request Recieved for GetAllRoomTypes, IsActive: {IsActive}",IsActive);

            try
            {
                var rooms = await _roomTypeRepository.RetrieveAllRoomTypesAsync(IsActive);
                return new APIResponse<List<RoomTypeDTO>>(rooms, "Retrieved all Room Types Successfull.");
        ...
        {
            _logger.LogInformation("Request Recieved for GetRoomTypeById, RoomTypeID: {RoomTypeID}",RoomTypeID);
        ...
        {
            _logger.LogInformation("Request Recieved for DeleteRoomType RoomTypeID: {RoomTypeID}", RoomTypeId);
