...
namespace HotelBookingAPI.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        {
            _logger.LogInformation("Request Recived for AddUser: {@CreateUserDTO}", createUserDTO);
            ...
            try
            {
                ...
                _logger.LogInformation("AddUser Response From Repositry: {@CreateUserResponseDTO}", response);
        ...
        {
            _logger.LogInformation("Request Recieved For AssignRole: {@UserRoleDTO}", userRoleDTO);
            if(!ModelState.IsValid)
            {
                _logger.LogInformation("Invalid Data in the Request Body");
            ...
            try
            {
                ...
                _logger.LogInformation("AssingRole Response From Repositry: {@UserRoleResponseDTO}",response);
        ...
        {
            _logger.LogInformation($"Request Recieved for GetAllUsers, IsActive = {isActive}");
        ...
        {
            _logger.LogInformation($"Request Recivied for GetUserById, ID: {userId}");
        ...
        {
            _logger.LogInformation("Request Recieved for UpdateUser {@UpdateUserDTO}", updateUserDTO);
            ...
            try
            {
                ...
                return new APIResponse<UpdateUserResponseDTO>(HttpStatusCode.BadGateway,response.Message);
            
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error updating user {UserID}", updateUserDTO.UserID);
                return new APIResponse<UpdateUserResponseDTO>(HttpStatusCode.InternalServerError,"Updated Failed.",ex.Message);
