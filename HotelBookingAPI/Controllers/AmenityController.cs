    ...
    public class AmenityController : ControllerBase
    {
        ...
        public async Task<APIResponse<AmenityFetchResultDTO>> FetchAmenities(bool? isActive = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(ex, "Error occured while fetching amenities.");
                return new APIResponse<AmenityFetchResultDTO>(HttpStatusCode.InternalServerError, "An error occred while processing your request", ex.Message);
            }
        }
        ...
        public async Task<APIResponse<AmenityDetailsDTO>> FetchAmenityById(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(ex, "Error occured while fetching amenity by ID");
