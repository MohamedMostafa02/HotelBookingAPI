    ...
    public class ReservationRepository
    {
        ...
        public async Task<CreateReservationResponseDTO> CreateReservationAsync(CreateReservationDTO reservation)
        {
            ...
            try
            {
                ...
                var reservationIdParam = command.Parameters["@ReservationID"].Value;
                createReservationResponseDTO.ReservationID = reservationIdParam == DBNull.Value ? 0 : Convert.ToInt32(reservationIdParam);
            }
            catch (Exception ex)
            {
                // Log exception here
        ...
        public async Task<ProcessPaymentResponseDTO> ProcessPaymentAsync(ProcessPaymentDTO payment)
        {
            ...
            try
            {
                ...
                processPaymentResponseDTO.PaymentID = command.Parameters["@PaymentID"].Value != DBNull.Value
                          ? Convert.ToInt32(command.Parameters["@PaymentID"].Value)
                          : 0;
